...
if __name__ == '__main__':
    print(get_number_of_parameters(VGG_A())) #9750922
    print(get_number_of_parameters(VGG_A_Light()))#285162
    print(get_number_of_parameters(VGG_A_Dropout()))#9750922
    print(get_number_of_parameters(VGG_A_BatchNorm()))#9756426